...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in gozer.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("gozer.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Gozer features */
    { "gozer",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "gozer",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "gozer",               "gobject",                &gobject,                true,  {} },
    { "gozer",               "voteraw",                &voteraw,                true,  {} },
