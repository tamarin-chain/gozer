...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Gozer address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "gozer",               "masternode",             &masternode,             true,  {} },
    { "gozer",               "masternodelist",         &masternodelist,         true,  {} },
    { "gozer",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "gozer",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "gozer",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "gozer",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
