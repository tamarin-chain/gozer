...
//! These need to be macros, as clientversion.cpp's and gozer*-res.rc's voodoo requires it
...
/**
 * gozerd-res.rc includes this file, but it cannot cope with real c++ code.
