...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Gozer related functionality
...
/*
    ...
    allow endless transaction that would bloat Gozer and make it unusable. To
