...
static const int64_t DEFAULT_MAX_TIP_AGE = 0.6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 6 * 60 * 60 in dash
/** Maximum age of our tip in seconds for us to be considered current for fee estimation */
static const int64_t MAX_FEE_ESTIMATION_TIP_AGE = 0.3 * 60 * 60;
