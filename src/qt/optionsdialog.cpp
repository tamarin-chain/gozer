    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GOZER-light"), QVariant("light"));
    ui->theme->addItem(QString("GOZER-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GOZER-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("GOZER-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("GOZER-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GOZER-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GOZER-traditional"), QVariant("trad"));
