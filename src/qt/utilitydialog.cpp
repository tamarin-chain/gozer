    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  gozer-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Gozer in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GOZER, 0.1 GOZER, 1 GOZER and 10 GOZER -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gozerpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://gozerpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
