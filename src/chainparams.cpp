...
public:
    CMainParams() {
        ...
        consensus.nSuperblockStartBlock = 614820; // NOTE: Should satisfy nSuperblockStartBlock > nBudgetPeymentsStartBlock
        ...
        consensus.nPowTargetTimespan = 1 * 60 * 60; // Gozer: 1 day
        consensus.nPowTargetSpacing = 15; // Gozer: 15 seconds
        ...
        // Gozer BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Gozer BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Gozer BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockStartHash = uint256();
        consensus.nSuperblockCycle = 24; // Superblocks can be issued every 6 minutes on testnet
        ...
        consensus.DIP0001Height = 2;
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 1 * 60 * 60; // Gozer: 1 hour
        consensus.nPowTargetSpacing = 15; // Gozer: 15 seconds
        ...
        // Testnet Gozer BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Gozer BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Gozer BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams() {
        ...
        consensus.nSuperblockCycle = 24; // Superblocks can be issued every 6 minutes on devnet
        consensus.nGovernanceMinQuorum = 1;
        consensus.nGovernanceFilterElements = 500;
        consensus.nMasternodeMinimumConfirmations = 1;
        consensus.BIP34Height = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.nSuperblockCycle = 10; // every 2.5 minutes
        consensus.nGovernanceMinQuorum = 1;
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Gozer BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Gozer BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Gozer BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
