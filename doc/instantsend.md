...
This mechanism has been integrated into Bitcore-Node-Gozer which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gozerpay/insight-api-gozer#web-socket-api](https://github.com/gozerpay/insight-api-gozer#web-socket-api)
* API: [https://github.com/gozerpay/insight-api-gozer#instantsend-transactions](https://github.com/gozerpay/insight-api-gozer#instantsend-transactions)
...
By default, the Gozer Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gozer Core daemon:
